...
type GreetServiceClient interface {
	...
	SayHelloBidirectionsalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionsalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBidirectionsalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionsalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBidirectionsalStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBidirectionsalStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBidirectionsalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBidirectionsalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBidirectionsalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionsalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBidirectionsalStreaming(GreetService_SayHelloBidirectionsalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirectionsalStreaming(GreetService_SayHelloBidirectionsalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirectionsalStreaming not implemented")
}
...
func _GreetService_SayHelloBidirectionsalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirectionsalStreaming(&greetServiceSayHelloBidirectionsalStreamingServer{stream})
}

type GreetService_SayHelloBidirectionsalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBidirectionsalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBidirectionsalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionsalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirectionsalStreaming",
			Handler:       _GreetService_SayHelloBidirectionsalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
